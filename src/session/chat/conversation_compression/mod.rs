...
// LLM I/O for the compression decision lives in the `ai` submodule;
// it builds the prompt internally via `super::prompt::build_compression_prompt`.
...
// Range determination + token-pricing live in the `range` submodule.
